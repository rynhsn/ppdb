...
//            'no_kip' => ['type' => 'VARCHAR', 'constraint' => '100', 'null' => true,],
            ...
            'file_surat_kelulusan' => ['type' => 'VARCHAR', 'constraint' => '100', 'null' => true,],
            'file_kk' => ['type' => 'VARCHAR', 'constraint' => '100', 'null' => true,],
            'file_ktp_ayah' => ['type' => 'VARCHAR', 'constraint' => '100', 'null' => true,],
            'file_ktp_ibu' => ['type' => 'VARCHAR', 'constraint' => '100', 'null' => true,],
            'file_akta' => ['type' => 'VARCHAR', 'constraint' => '100', 'null' => true,],
            'file_foto' => ['type' => 'VARCHAR', 'constraint' => '100', 'null' => true,],
            'file_ijazah' => ['type' => 'VARCHAR', 'constraint' => '100', 'null' => true,],
            'file_kip' => ['type' => 'VARCHAR', 'constraint' => '100', 'null' => true,],
